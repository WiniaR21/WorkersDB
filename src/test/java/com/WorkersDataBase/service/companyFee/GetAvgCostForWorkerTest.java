...
class GetAvgCostForWorkerTest {
    ...
    @Test
    void getAvgCostForWorker_should_return_0() {
        //  Arrange
        arrange_company_repo_count_zero(companyFeeRepository);
        //  Assert
        assertEquals(0, underTest.getAvgCostForWorker());
    }
    @Test
    void getAvgCostForWorker_should_return_20() {
        //  Arrange
        arrange_company_repo_count_one(companyFeeRepository);
        arrange_math_tool_returns_10(tools);
        arrange_company_repo_getAvgCostForWorker_returns_10(companyFeeRepository);
        //  Assert
        assertEquals(20,underTest.getAvgCostForWorker());
    }
}